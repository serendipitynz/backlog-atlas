...
<!-- AC:BEGIN -->
- [ ] #1 通知だけが × で閉じられる
- [ ] #2 行非表示の帯に族の色を与えない（利用者が自分で隠した中立の状態として出す）
- [ ] #3 CLI 縮退と台帳読取専用を独立した帯として doc-11 §4 の位置（② と ③）に置き、同時に立ちうる帯を 6 本までに保つ
- [ ] #4 上部帯 6 種を doc-11 §4 の固定順で積み、出現順にしない
- [ ] #5 確認・CLI 縮退・台帳読取専用・継続検出停止に閉じる操作を置かない（回答・復旧・再読込で消える）
<!-- AC:END -->
