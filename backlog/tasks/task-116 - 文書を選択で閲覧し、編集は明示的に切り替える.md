...
- [ ] #2 閲覧ヘッダに title・type・tags・表示パスが出る
- [ ] #3 編集中に別カードを選ぶ経路の破棄前確認は現在の契約を維持する
- [ ] #4 選択=閲覧への変更が doc-10 §5 に記録されている
- [ ] #5 閲覧から編集への切替で現行の編集セッション (doc-10 §5 の文書区画自身の破棄前確認契約に従う未保存管理) に切り替わる
<!-- AC:END -->
