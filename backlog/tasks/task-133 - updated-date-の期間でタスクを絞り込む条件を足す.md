...
- [ ] #2 期間の端を含むか含まないかが決まっており、doc-7 §5 に書かれている
- [ ] #3 比較に使う時刻の基準（frontmatter の値をどの時間帯として読むか）が決まっており、doc-7 §5 に書かれている
- [ ] #4 updated date を持たないタスクと、解析できない値を持つタスクの扱いが決まっており、doc-7 §5 に書かれている
- [ ] #5 in X days / weeks / months のショートカットが指定でき、暦上の意味（日数換算か暦月か）と評価する時点が doc-7 §5 に書かれている
- [ ] #6 上の 4 点それぞれに試験がある
- [ ] #7 期間の条件が絞り込みトークンとして帯に出て、既定に戻す と 直前の 1 つを戻す が効く
- [ ] #8 doc-7 §5 のファセット列に本条件が加わっている
<!-- AC:END -->
