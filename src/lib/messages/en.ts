...
export const EN: Catalog = {
  ...
  shell: {
    ...
    releasePageLabel: "Open the releases page",
    releaseNoticeAvailable: (version: string) => `Version ${version} is out`,
    menuHasReleaseNotice: (label: string) => `${label} (a new version is out)`,
